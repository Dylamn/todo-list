...
const toggleMenu = e => {
  ...
  const expanded = button.classList.toggle(Styles.opened)
...
const Header = () => (
  <header className="w-full shadow">
    <nav className="flex items-center justify-between px-8 py-2">
      ...
      <div className="flex flex-row items-center">
        <div className="flex justify-end rounded-full w-20 p-1 border-2">
          <div className="relative mr-1">
            <button className={Styles['hamburger-menu']} onClick={toggleMenu} aria-label="Main Menu">
